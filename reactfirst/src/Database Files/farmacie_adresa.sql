...
CREATE TABLE `adresa` (
  ...
  `Tip_adresa` varchar(45) NOT NULL,
  `Utilizator_ID` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`Adresa_ID`),
  KEY `Utilizator_ID_idx` (`Utilizator_ID`),
  CONSTRAINT `Utilizator_adresa` FOREIGN KEY (`Utilizator_ID`) REFERENCES `utilizator` (`Utilizator_ID`)
...
INSERT INTO `adresa` VALUES (1,'BR','BR','BR','11W','11212','Acasa',1),(2,'GL','GL','GL','11A','123456','Munca',1),(3,'BR','BR','BR','11W','11212','Acasa',1),(4,'BR','BR','BR','11W','11212','Acasa',6),(5,'Bucharest','Bucharest','Iuliu maniu, 184, ap 13, bloc G','1q','060029','Home',6);
